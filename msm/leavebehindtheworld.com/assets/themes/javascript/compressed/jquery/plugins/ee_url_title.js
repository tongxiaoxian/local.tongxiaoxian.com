...
for("boolean"!=typeof t&&(t=!1),""!==i&&"title"===e(this).attr("id")&&u.substr(0,i.length)===i&&(u=u.substr(i.length)),u=c+u,u=u.toLowerCase().replace(h,s),l=0;l<u.length;l++)a=u.charCodeAt(l),a>=32&&128>a?n+=u.charAt(l):a in p&&(n+=p[a]);u=n,u=u.replace("/<(.*?)>/g",""),u=u.replace(/\s+/g,s),u=u.replace(/\//g,s),u=u.replace(/[^a-z0-9\-\._]/g,""),u=u.replace(/\+/g,s),u=u.replace(E,s),u=u.replace(/^[\-\_]|[\-\_]$/g,""),u=u.replace(/\.+$/g,""),t&&(u=u.replace(/\./g,"")),r&&e(r).val(u.substring(0,75))})}}(jQuery);