...
// Create element
var e=t(this),i=t.extend(!0,{},o.options),f=t.effects.setMode(e,o.options.mode||"effect"),r=parseInt(o.options.percent,10)||(0==parseInt(o.options.percent,10)?0:"hide"==f?0:100),h=o.options.direction||"both",n=o.options.origin;// The origin of the scaling
"effect"!=f&&(// Set default origin and restore for show/hide
i.origin=n||["middle","center"],i.restore=!0);var s={height:e.height(),width:e.width()};// Save original
...
w.from.y!=w.to.y&&(// Vertical props scaling
i=i.concat(n),e.from=t.effects.setTransition(e,n,w.from.y,e.from),e.to=t.effects.setTransition(e,n,w.to.y,e.to)),w.from.x!=w.to.x&&(// Horizontal props scaling
i=i.concat(s),e.from=t.effects.setTransition(e,s,w.from.x,e.from),e.to=t.effects.setTransition(e,s,w.to.x,e.to))),"content"!=d&&"both"!=d||// Scale the content
w.from.y!=w.to.y&&(// Vertical props scaling
i=i.concat(h),e.from=t.effects.setTransition(e,h,w.from.y,e.from),e.to=t.effects.setTransition(e,h,w.to.y,e.to)),t.effects.save(e,a?i:f),e.show(),// Save & Show
t.effects.createWrapper(e),// Create Wrapper
e.css("overflow","hidden").css(e.from),// Shift
// Animate
"content"!=d&&"both"!=d||(// Scale the children
n=n.concat(["marginTop","marginBottom"]).concat(h),// Add margins/font-size
s=s.concat(["marginLeft","marginRight"]),// Add margins
r=i.concat(n).concat(s),// Concat
e.find("*[width]").each(function(){var e=t(this);a&&t.effects.save(e,r);var i={height:e.height(),width:e.width()};// Save original
e.from={height:i.height*w.from.y,width:i.width*w.from.x},e.to={height:i.height*w.to.y,width:i.width*w.to.x},w.from.y!=w.to.y&&(// Vertical props scaling
e.from=t.effects.setTransition(e,n,w.from.y,e.from),e.to=t.effects.setTransition(e,n,w.to.y,e.to)),w.from.x!=w.to.x&&(// Horizontal props scaling
e.from=t.effects.setTransition(e,s,w.from.x,e.from),e.to=t.effects.setTransition(e,s,w.to.x,e.to)),e.css(e.from),// Shift children
e.animate(e.to,o.duration,o.options.easing,function(){a&&t.effects.restore(e,r)})})),
// Animate
