 ...
 */
   ...
   $assign_to_config['cp_url'] = 'http://www.lightisbeautiful.com/admin.php'; 
   $assign_to_config['site_url'] = 'http://www.lightisbeautiful.com/'; 
...
$assign_to_config['tmpl_file_basepath'] = '/var/www/html/tongxiaoxian.com/msm/lightisbeautiful.com/templates';

$assign_to_config['upload_preferences'] = array(
    11 => array(                                                            // ID of upload destination
        'name'        => 'works_cn',                          // Display name in control panel
        'server_path' => '/var/www/html/tongxiaoxian.com/msm/lightisbeautiful.com/assets/images/uploads/works_cn/', // Server path to upload directory
        'url'         => 'http://www.lightisbeautiful.com/assets/images/uploads/works_cn/'      // URL of upload directory
    ),
    17 => array(                                                            // ID of upload destination
        'name'        => 'works_en',                          // Display name in control panel
        'server_path' => '/var/www/html/tongxiaoxian.com/msm/lightisbeautiful.com/assets/images/uploads/works_en/', // Server path to upload directory
        'url'         => 'http://www.lightisbeautiful.com/assets/images/uploads/works_en/'      // URL of upload directory
    )            
);
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/var/www/html/tongxiaoxian.com/msm/lightisbeautiful.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://www.lightisbeautiful.com/cache',
