...
class Publish
{
	...
	public function build_categories_block($cat_group_ids, $entry_id, $selected_categories, $default_category = '', $file = FALSE)
	{
		...
		if ($this->can_edit_categories($cat_group_ids))
		{
	...
	protected function can_edit_categories($cat_group_ids)
	{
		...
		{
			ee()->db->select('can_edit_categories');
			ee()->db->where_in('group_id', $cat_group_ids);
