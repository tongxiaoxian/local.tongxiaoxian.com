...
e.test(tab_name)?""===tab_name?$.ee_notice(EE.lang.tab_name_required):_add_tab(tab_name)?$("#new_tab_dialog").dialog("close"):$.ee_notice(EE.lang.duplicate_tab_name):$.ee_notice(EE.lang.illegal_tab_name)},$("#tab_name").keypress(function(e){if("13"==e.keyCode)// return key press
return add_publish_tab(),!1}),
