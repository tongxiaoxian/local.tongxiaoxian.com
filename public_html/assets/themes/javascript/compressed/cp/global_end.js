...
jQuery().toggle_all&&e(this).toggle_all()}),EE.registered===!1&&!function(e,t){
// use the unregisteredbanner extension to modify the encoded
// message in unregistered.js then paste here
e("#mainMenu").length&&e("body").prepend('<div class="nanner"><p>This copy of ExpressionEngine is <strong>unregistered</strong>. Please visit the <a href="#" onclick="location.href=EE.BASE + \'&C=admin_system&M=software_registration\'">Software Registration</a> page to enter your license information.</p></div>')}(jQuery,this)}(jQuery);